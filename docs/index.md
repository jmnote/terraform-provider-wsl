...
- [`wsl_distribution`](resources/distribution.md) (resource): install/import,
  observe, update, and delete a WSL distribution's registration.
- [`wsl_distribution`](data-sources/distribution.md) (data source): look up
